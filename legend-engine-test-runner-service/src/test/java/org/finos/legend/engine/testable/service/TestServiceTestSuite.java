...
public class TestServiceTestSuite
{
    ...
    public void testServiceTestSuiteWithServiceStore()
    {
        ...
        //service store service as inline service
    ...
    public void testServiceTestSuiteWithModelStore()
    {
        ...
        String inlineService = "###Service\n" +
                ...
                "  execution: Single\n" +
                "  {\n" +
                "    query: |testModelStoreTestSuites::model::Doc.all()->graphFetchChecked(#{testModelStoreTestSuites::model::Doc{firm_tbl{addressId,firmId,legalName,ceoId},person_tbl{addressId,age,firmId,firstName,id,lastName}}}#)->from(testModelStoreTestSuites::mapping::DocM2MMapping, testModelStoreTestSuites::runtime::DocM2MRuntime)->serialize(#{testModelStoreTestSuites::model::Doc{firm_tbl{addressId,firmId,legalName,ceoId},person_tbl{addressId,age,firmId,firstName,id,lastName}}}#);\n" +
                "  }\n" +
                "  testSuites:\n" +
                "  [\n" +
                "    testSuite1:\n" +
